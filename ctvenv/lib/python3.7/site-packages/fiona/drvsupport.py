...
def _driver_converts_field_type_silently_to_str(driver, field_type):
    ...
    """
    if (
        field_type in _driver_converts_to_str
        and driver in _driver_converts_to_str[field_type]
    ):
...
def _driver_supports_field(driver, field_type):
    ...
    """
    if (
        field_type in _driver_field_type_unsupported
        and driver in _driver_field_type_unsupported[field_type]
    ):
...
def _driver_supports_timezones(driver, field_type):
    ...
    """
    if (
        field_type in _drivers_not_supporting_timezones
        and driver in _drivers_not_supporting_timezones[field_type]
    ):
...
_drivers_not_supporting_milliseconds = {"GPSTrackMaker": None, "FileGDB": None}
...
def _driver_supports_milliseconds(driver):
    ...
    if driver in _drivers_not_supporting_milliseconds:
        if _drivers_not_supporting_milliseconds[driver] is None:
            ...
            calc_gdal_version_num(*_drivers_not_supporting_milliseconds[driver])
