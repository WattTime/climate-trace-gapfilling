...
@click.option(
    "--crs", "meta_member", flag_value="crs", help="Print the CRS as a PROJ.4 string."
)
@click.option(
    "--bounds",
    "meta_member",
    flag_value="bounds",
    help="Print the boundary coordinates " "(left, bottom, right, top).",
)
@click.option(
