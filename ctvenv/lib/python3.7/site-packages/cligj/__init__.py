...
features_in_arg = click.argument(
    "features", nargs=-1, callback=normalize_feature_inputs, metavar="FEATURES..."
)
...
format_opt = click.option(
    "-f", "--format", "--driver", "driver", default="GTiff", help="Output format driver"
)
...
precision_opt = click.option(
    "--precision", type=int, default=-1, help="Decimal precision of coordinates."
)
