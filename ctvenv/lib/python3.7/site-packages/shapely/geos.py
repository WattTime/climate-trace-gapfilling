...
class WKTWriter:
    ...
    def output_dimension(self):
        ...
        return self._lgeos.GEOSWKTWriter_getOutputDimension(self._writer)

    @output_dimension.setter
    def output_dimension(self, value):
        self._lgeos.GEOSWKTWriter_setOutputDimension(self._writer, int(value))
...
class WKBWriter:
    ...
    @output_dimension.setter
    def output_dimension(self, value):
        self._lgeos.GEOSWKBWriter_setOutputDimension(self._writer, int(value))

    @property
    def big_endian(self):
        """Byte order is big endian, True (default) or False"""
        return self._lgeos.GEOSWKBWriter_getByteOrder(self._writer) == self._ENDIAN_BIG
...
class LGEOS330(LGEOSBase):
    ...
    def __init__(self, dll):
        ...
        def parallel_offset(
            geom, distance, resolution=16, join_style=1, mitre_limit=5.0, side="right"
        ):
            if side == "right":
                distance *= -1
        ...
        self.methods["interpolate_normalized"] = self.GEOSInterpolateNormalized
