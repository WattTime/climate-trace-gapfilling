...
class TestBayes_mvs:
    def test_basic(self):
        ...
        assert_allclose(
            mean.minmax, (7.1036502226125329, 10.896349777387467), rtol=1e-14
        )
...
class TestMvsdist:
    def test_basic(self):
        ...
        assert_allclose(
            mean.interval(0.9), (7.1036502226125329, 10.896349777387467), rtol=1e-14
        )
...
class TestAndersonKSamp:
    ...
    def test_example2a(self):
        ...
        Tk, tm, p = stats.anderson_ksamp(
            (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14), midrank=False
        )
...
class TestMood:
    def test_mood(self):
        ...
        x1 = np.arange(5)
        assert_array_almost_equal(
            stats.mood(x1, x1**2), (-1.3830857299399906, 0.16663858066771478), 11
        )
...
class TestCircFuncs:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (stats.circvar, {None: np.nan, 0: 16.89976130, 1: 36.51366669}),
