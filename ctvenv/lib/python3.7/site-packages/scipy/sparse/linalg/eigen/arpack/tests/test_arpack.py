...
def test_svds_partial_return():
    ...
    if dvh > 1e-10:
        raise AssertionError(
            "right eigenvector matrices differ when using return_singular_vectors parameter"
        )
    ...
    if du > 1e-10:
        raise AssertionError(
            "left eigenvector matrices differ when using return_singular_vectors parameter"
        )
