...
def solve_bvp(
    ...
    if y.shape[1] != x.shape[0]:
        raise ValueError(
            "`y` is expected to have {} columns, but actually "
    ...
    if f.shape != y.shape:
        raise ValueError(
            "`fun` return is expected to have shape {}, "
    ...
    if bc_res.shape != (n + k,):
        raise ValueError(
            "`bc` return is expected to have shape {}, "
    ...
    if verbose > 0:
        if status == 0:
            print(
                ...
                "Maximum boundary residual: {:.2e}".format(
                    iteration, x.shape[0], max_rms_res, max_bc_res
                )
            )
        elif status == 1:
            print(
                ...
                "Maximum relative residual: {:.2e} \n"
                "Maximum boundary residual: {:.2e}".format(
                    iteration, max_rms_res, max_bc_res
                )
            )
        elif status == 2:
            print(
