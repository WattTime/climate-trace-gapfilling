...
class TestWelch:
    ...
    def test_window_correction(self):
        ...
        for window in ["hann", "bartlett", ("tukey", 0.1), "flattop"]:
            ...
            assert_allclose(
                np.sqrt(np.trapz(p_dens, freq)), A * np.sqrt(2) / 2, rtol=1e-3
            )
...
class TestSTFT:
    def test_input_validation(self):
        ...
        assert_raises(
            ValueError, istft, z, nperseg=256, noverlap=0, window="hann"
        )  # Doesn't meet COLA
    ...
    def test_roundtrip_complex(self):
        ...
        tr, xr = istft(
            zz, nperseg=nperseg, noverlap=noverlap, window=window, input_onesided=False
        )
