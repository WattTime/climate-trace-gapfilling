...
def configuration(parent_package="", top_path=None):
    ...
    ufuncs_dep = (
        headers + ufuncs_src + amos_src + cephes_src + mach_src + cdf_src + specfun_src
    )
    cfg = combine_dict(
        lapack_opt,
    ...
    cython_special = config.add_extension(
        "cython_special",
    ...
    for name in ["boost", "gsl", "local"]:
        subprocess.check_call(
            [sys.executable, makenpz, "--use-timestamp", os.path.join(data_dir, name)]
        )
