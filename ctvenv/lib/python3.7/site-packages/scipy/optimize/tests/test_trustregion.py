...
from scipy.optimize import minimize, rosen, rosen_der, rosen_hess, rosen_hess_prod, BFGS
...
class TestTrustRegionSolvers:
    ...
    def test_finite_differences(self):
        ...
        product = itertools.product(FD_METHODS + (BFGS,), methods)
        ...
        for fd, method in product:
            ...
            r = minimize(
                rosen, x0=self.x_opt, jac=rosen_der, hess=hess, tol=1e-8, method=method
            )
            assert_allclose(self.x_opt, r["x"])
